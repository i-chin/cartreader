...
#define ATARI_JAGUAR_ROM_SIZE 168 // ATARI5200 ROM SIZE
#define ATARI_JAGUAR_EEP_SIZE 169 // ATARI5200 EEP SIZE
...
void resetEEPROM() {
  ...
  EEPROM_writeAnything(ATARI_JAGUAR_ROM_SIZE, (byte)0);   // ATARI JAGUAR ROM SIZE
  EEPROM_writeAnything(ATARI_JAGUAR_EEP_SIZE, (byte)0);   // ATARI JAGUAR EEP SIZE
